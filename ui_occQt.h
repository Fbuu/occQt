...
public:
    ...
    {
        occQtClass->setWindowTitle(QApplication::translate("occQtClass", "occQt", 0));
        actionExit->setText(QApplication::translate("occQtClass", "Exit", 0));
        actionExit->setShortcut(QApplication::translate("occQtClass", "Ctrl+Q", 0));
        actionZoom->setText(QApplication::translate("occQtClass", "Zoom", 0));
        actionPan->setText(QApplication::translate("occQtClass", "Pan", 0));
        actionRotate->setText(QApplication::translate("occQtClass", "Rotate", 0));
        actionReset->setText(QApplication::translate("occQtClass", "Reset", 0));
        actionFitAll->setText(QApplication::translate("occQtClass", "FitAll", 0));
        actionAbout->setText(QApplication::translate("occQtClass", "About", 0));
        actionBox->setText(QApplication::translate("occQtClass", "Box", 0));
        actionCone->setText(QApplication::translate("occQtClass", "Cone", 0));
        actionSphere->setText(QApplication::translate("occQtClass", "Sphere", 0));
        actionCylinder->setText(QApplication::translate("occQtClass", "Cylinder", 0));
        actionTorus->setText(QApplication::translate("occQtClass", "Torus", 0));
        actionFillet->setText(QApplication::translate("occQtClass", "Fillet", 0));
        actionChamfer->setText(QApplication::translate("occQtClass", "Chamfer", 0));
        actionExtrude->setText(QApplication::translate("occQtClass", "Extrude", 0));
        actionRevolve->setText(QApplication::translate("occQtClass", "Rovelve", 0));
        actionLoft->setText(QApplication::translate("occQtClass", "Loft", 0));
        actionCut->setText(QApplication::translate("occQtClass", "Cut", 0));
        actionFuse->setText(QApplication::translate("occQtClass", "Fuse", 0));
        actionCommon->setText(QApplication::translate("occQtClass", "Common", 0));
        actionHelix->setText(QApplication::translate("occQtClass", "Helix", 0));
        menuFile->setTitle(QApplication::translate("occQtClass", "File", 0));
        menuView->setTitle(QApplication::translate("occQtClass", "View", 0));
        menuPrimitive->setTitle(QApplication::translate("occQtClass", "Primitive", 0));
        menuModeling->setTitle(QApplication::translate("occQtClass", "Modeling", 0));
        menuHelp->setTitle(QApplication::translate("occQtClass", "Help", 0));
    } // retranslateUi
